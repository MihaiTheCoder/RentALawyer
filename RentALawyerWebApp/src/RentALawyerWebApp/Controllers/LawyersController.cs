...
using RentALawyerWebApp.Models;

namespace RentALawyerWebApp.Controllers
{
    public class LawyersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var lawyer = await _context.Lawyer.SingleOrDefaultAsync(m => m.ID == id);
            if (lawyer == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName")] Lawyer lawyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName")] Lawyer lawyer)
        {
            if (id != lawyer.ID)
            {
                return NotFound();
